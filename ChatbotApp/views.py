...
def trainModel():
    ...
    questions = []
    answers = []
    con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'Mokshith3953@', database = 'AIChatbot',charset='utf8')
    with con:
        cur = con.cursor()
...
def record(request):
    if request.method == "POST":
        ...
        path = 'C:/Users/moksh_feb7a4d/OneDrive/Desktop/AIChatbot/ChatbotApp/static/'
        ...
        with con:    
            ...
            for row in rows:
                if row[0] == username:
                    ...
                    break
        if status == "none":
            db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'Mokshith3953@', database = 'AIChatbot',charset='utf8')
